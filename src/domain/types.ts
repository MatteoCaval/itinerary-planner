...
export type LegacyAccommodation = { name: string; lat?: number; lng?: number; cost?: number; notes?: string; link?: string };
export type LegacyDay = { id: string; date: string; label?: string; accommodation?: LegacyAccommodation };
export type LegacyRoute = { id: string; fromLocationId: string; toLocationId: string; transportType: LegacyTransportType; duration?: string; cost?: number; notes?: string };
