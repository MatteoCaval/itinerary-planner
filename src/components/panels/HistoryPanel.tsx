            ...
            >
              <div className="flex items-start gap-2.5 min-w-0">
                ...
                <div className="min-w-0">
                  <p
                    className={`text-xs font-semibold truncate ${isCurrent ? 'text-primary' : 'text-slate-700'}`}
                  >
                    {snap.trip.name}
                  </p>
                  <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                    ...
                    {staysDiff !== null && staysDiff !== 0 && (
                      <Badge
                        variant="secondary"
                        className={`text-[9px] font-bold h-auto px-1.5 py-px ${staysDiff > 0 ? 'text-emerald-600 bg-emerald-50' : 'text-red-500 bg-red-50'}`}
                      >
                    ...
                    {placesDiff !== null && placesDiff !== 0 && (
                      <Badge
                        variant="secondary"
                        className={`text-[9px] font-bold h-auto px-1.5 py-px ${placesDiff > 0 ? 'text-emerald-600 bg-emerald-50' : 'text-red-500 bg-red-50'}`}
                      >
