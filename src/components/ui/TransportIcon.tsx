...
import {
  Train, Plane, Car, Ship, Bus, Footprints,
  Landmark, Palette, UtensilsCrossed, ShoppingBag, MapPin,
} from 'lucide-react';
import type { TravelMode, VisitType } from '@/domain/types';

export default function TransportIcon({ mode, className = 'w-3.5 h-3.5' }: { mode: TravelMode; className?: string }) {
